    ...
    for (i = 0; i < countryInput.length; i++) {
        ...
        if (flag) {
            ...
            $.each(countries, function (index, country) {
                ...
                countryList += "<option data-country-code='" + country.code.toLowerCase() + "' data-tokens='" + country.code + " " + country.name + "' style='padding-left:25px; background-position: 4px 7px; background-image:url(" + flagIcon + ");background-repeat:no-repeat;' value='" + country.name + "'>" + country.name + "</option>";
            });
            ...
            $.each(countries, function (index, country) {
                countryList += "<option data-country-code='" + country.code.toLowerCase() + "' data-tokens='" + country.code + " " + country.name + "' value='" + country.name + "'>" + country.name + "</option>";
            });
